...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MateriaImpartidaEnGrupo.cupo'
        db.add_column(u'principal_materiaimpartidaengrupo', 'cupo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MateriaImpartidaEnGrupo.cupo'
        db.delete_column(u'principal_materiaimpartidaengrupo', 'cupo')
    ...
    models = {
        ...
        u'principal.materiaimpartidaengrupo': {
            ...
            'cupo': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
