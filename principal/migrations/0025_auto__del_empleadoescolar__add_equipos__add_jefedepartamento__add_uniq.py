...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'principal_equipos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombreEquipo', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('numero_serie', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('descripcionEquipo', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('observaciones', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('laboratorio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Laboratorio'])),
        ))
        db.send_create_signal(u'principal', ['Equipos'])

        # Adding model 'JefeDepartamento'
        db.create_table(u'principal_jefedepartamento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cve_depto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Depto'], unique=True)),
            ('cve_prof', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Profesor'], unique=True)),
        ))
        db.send_create_signal(u'principal', ['JefeDepartamento'])

        # Adding unique constraint on 'JefeDepartamento', fields ['cve_depto', 'cve_prof']
        db.create_unique(u'principal_jefedepartamento', ['cve_depto_id', 'cve_prof_id'])

        # Adding field 'Laboratorio.numero'
        db.add_column(u'principal_laboratorio', 'numero',
                      self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Laboratorio.encargado'
        db.add_column(u'principal_laboratorio', 'encargado',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Profesor'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Depto.jefe_depto'
        db.delete_column(u'principal_depto', 'jefe_depto_id')

        # Deleting field 'Profesor.lab_a_mi_cargo'
        db.delete_column(u'principal_profesor', 'lab_a_mi_cargo_id')

        # Adding field 'Profesor.Departamento'
        db.add_column(u'principal_profesor', 'Departamento',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Depto'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Profesor.comentario'
        db.alter_column(u'principal_profesor', 'comentario', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'JefeDepartamento', fields ['cve_depto', 'cve_prof']
        db.delete_unique(u'principal_jefedepartamento', ['cve_depto_id', 'cve_prof_id'])
        ...
        db.delete_table(u'principal_equipos')

        # Deleting model 'JefeDepartamento'
        db.delete_table(u'principal_jefedepartamento')

        # Deleting field 'Laboratorio.numero'
        db.delete_column(u'principal_laboratorio', 'numero')

        # Deleting field 'Laboratorio.encargado'
        db.delete_column(u'principal_laboratorio', 'encargado_id')

        # Adding field 'Depto.jefe_depto'
        db.add_column(u'principal_depto', 'jefe_depto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Usuario'], null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Profesor.Departamento'
        db.delete_column(u'principal_profesor', 'Departamento_id')


        # Changing field 'Profesor.comentario'
        db.alter_column(u'principal_profesor', 'comentario', self.gf('django.db.models.fields.CharField')(default=0, max_length=400))
