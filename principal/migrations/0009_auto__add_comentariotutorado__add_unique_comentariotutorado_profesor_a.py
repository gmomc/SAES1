...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ComentarioTutorado'
        db.create_table(u'principal_comentariotutorado', (
            ...
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True, blank=True)),
        ))
        db.send_create_signal(u'principal', ['ComentarioTutorado'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ComentarioTutorado'
        db.delete_table(u'principal_comentariotutorado')
