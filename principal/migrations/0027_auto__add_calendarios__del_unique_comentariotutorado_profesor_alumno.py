...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ComentarioTutorado', fields ['profesor', 'alumno']
        db.delete_unique(u'principal_comentariotutorado', ['profesor_id', 'alumno_id'])

        # Adding model 'calendarios'
        db.create_table(u'principal_calendarios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clave', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, db_index=True)),
            ('inicinscr', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('fininscr', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inicord', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('finord', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inicextra', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('finextra', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inicetes', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('finets', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'principal', ['calendarios'])


    def backwards(self, orm):
        # Deleting model 'calendarios'
        db.delete_table(u'principal_calendarios')

        # Adding unique constraint on 'ComentarioTutorado', fields ['profesor', 'alumno']
        db.create_unique(u'principal_comentariotutorado', ['profesor_id', 'alumno_id'])
