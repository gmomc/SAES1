...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocSolicitado.alumno_kardex'
        db.delete_column(u'principal_docsolicitado', 'alumno_kardex_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DocSolicitado.alumno_kardex'
        raise RuntimeError("Cannot reverse this migration. 'DocSolicitado.alumno_kardex' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DocSolicitado.alumno_kardex'
        db.add_column(u'principal_docsolicitado', 'alumno_kardex',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.kardex']),
                      keep_default=False)
