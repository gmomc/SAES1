...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.alergias'
        db.alter_column(u'principal_usuario', 'alergias', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Usuario.seguroMedico'
        db.alter_column(u'principal_usuario', 'seguroMedico', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Usuario.sexo'
        db.alter_column(u'principal_usuario', 'sexo', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Usuario.enfermedades'
        db.alter_column(u'principal_usuario', 'enfermedades', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Usuario.alergias'
        db.alter_column(u'principal_usuario', 'alergias', self.gf('django.db.models.fields.CharField')(default=0, max_length=80))

        # Changing field 'Usuario.seguroMedico'
        db.alter_column(u'principal_usuario', 'seguroMedico', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'Usuario.sexo'
        db.alter_column(u'principal_usuario', 'sexo', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Usuario.enfermedades'
        db.alter_column(u'principal_usuario', 'enfermedades', self.gf('django.db.models.fields.CharField')(default=0, max_length=80))
