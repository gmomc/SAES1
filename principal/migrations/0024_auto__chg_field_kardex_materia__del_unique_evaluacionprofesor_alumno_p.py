...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'kardex.materia'
        db.alter_column(u'principal_kardex', 'materia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Materia']))

    def backwards(self, orm):

        # Changing field 'kardex.materia'
        db.alter_column(u'principal_kardex', 'materia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.MateriaImpartidaEnGrupo']))
