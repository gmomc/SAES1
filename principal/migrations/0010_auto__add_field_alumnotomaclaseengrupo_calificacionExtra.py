...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumnoTomaClaseEnGrupo.calificacionExtra'
        db.add_column(u'principal_alumnotomaclaseengrupo', 'calificacionExtra',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumnoTomaClaseEnGrupo.calificacionExtra'
        db.delete_column(u'principal_alumnotomaclaseengrupo', 'calificacionExtra')
