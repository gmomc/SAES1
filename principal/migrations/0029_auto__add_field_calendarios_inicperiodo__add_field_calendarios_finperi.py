...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'calendarios.inicperiodo'
        db.add_column(u'principal_calendarios', 'inicperiodo',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'calendarios.finperiodo'
        db.add_column(u'principal_calendarios', 'finperiodo',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'calendarios.inicperiodo'
        db.delete_column(u'principal_calendarios', 'inicperiodo')

        # Deleting field 'calendarios.finperiodo'
        db.delete_column(u'principal_calendarios', 'finperiodo')
