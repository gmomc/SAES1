...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CitaInsc.inscrito'
        db.add_column(u'principal_citainsc', 'inscrito',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CitaInsc.inscrito'
        db.delete_column(u'principal_citainsc', 'inscrito')
