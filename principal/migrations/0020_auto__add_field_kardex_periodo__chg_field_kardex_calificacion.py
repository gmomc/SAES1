...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'kardex.periodo'
        db.add_column(u'principal_kardex', 'periodo',
                      self.gf('django.db.models.fields.CharField')(default=11, max_length=6),
                      keep_default=False)


        # Changing field 'kardex.calificacion'
        db.alter_column(u'principal_kardex', 'calificacion', self.gf('django.db.models.fields.IntegerField')(default=5))

    def backwards(self, orm):
        # Deleting field 'kardex.periodo'
        db.delete_column(u'principal_kardex', 'periodo')


        # Changing field 'kardex.calificacion'
        db.alter_column(u'principal_kardex', 'calificacion', self.gf('django.db.models.fields.IntegerField')(null=True))
