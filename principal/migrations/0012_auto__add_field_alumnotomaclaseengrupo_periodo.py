...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumnoTomaClaseEnGrupo.periodo'
        db.add_column(u'principal_alumnotomaclaseengrupo', 'periodo',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumnoTomaClaseEnGrupo.periodo'
        db.delete_column(u'principal_alumnotomaclaseengrupo', 'periodo')
