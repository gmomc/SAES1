...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grupo.turno'
        db.add_column(u'principal_grupo', 'turno',
                      self.gf('django.db.models.fields.CharField')(default='Matutino', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grupo.turno'
        db.delete_column(u'principal_grupo', 'turno')
