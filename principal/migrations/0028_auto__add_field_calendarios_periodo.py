...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'calendarios.periodo'
        db.add_column(u'principal_calendarios', 'periodo',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'calendarios.periodo'
        db.delete_column(u'principal_calendarios', 'periodo')
