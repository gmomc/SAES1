...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CitaInsc'
        db.create_table(u'principal_citainsc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alumno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Alumno'])),
            ('cita', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date.today, null=True, blank=True)),
        ))
        db.send_create_signal(u'principal', ['CitaInsc'])


    def backwards(self, orm):
        # Deleting model 'CitaInsc'
        db.delete_table(u'principal_citainsc')
    ...
    models = {
        ...
        u'principal.citainsc': {
            'Meta': {'object_name': 'CitaInsc'},
            'alumno': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Alumno']"}),
            'cita': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date.today', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
