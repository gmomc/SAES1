...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CitaInsc', fields ['cita', 'alumno']
        db.create_unique(u'principal_citainsc', ['cita', 'alumno_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CitaInsc', fields ['cita', 'alumno']
        db.delete_unique(u'principal_citainsc', ['cita', 'alumno_id'])
