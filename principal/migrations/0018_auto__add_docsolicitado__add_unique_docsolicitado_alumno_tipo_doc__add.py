...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'principal_docsolicitado', (
            ...
            ('tipo_doc', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('solicitudes_hechas', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('alumno_kardex', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.kardex'])),
        ))
        ...
        db.create_unique(u'principal_saberesprevios', ['Alumno_id', 'Materia_id'])
        ...
        db.create_table(u'principal_kardex', (
            ...
            ('materia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Materia'])),
            ('calificacion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('alumno_grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.AlumnoTomaClaseEnGrupo'])),
            ('total_creditos', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('evaluacion', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
        ))
        ...
        db.create_table(u'principal_evaluacionprofesor', (
            ...
            ('materia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Materia'])),
            ('pregunta1', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('pregunta2', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('pregunta3', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('pregunta4', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('pregunta5', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        ...
        db.create_unique(u'principal_evaluacionprofesor', ['alumno_id', 'profesor_id', 'materia_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EvaluacionProfesor', fields ['alumno', 'profesor', 'materia']
        db.delete_unique(u'principal_evaluacionprofesor', ['alumno_id', 'profesor_id', 'materia_id'])

        # Removing unique constraint on 'kardex', fields ['alumno', 'materia']
        db.delete_unique(u'principal_kardex', ['alumno_id', 'materia_id'])

        # Removing unique constraint on 'SaberesPrevios', fields ['Alumno', 'Materia']
        db.delete_unique(u'principal_saberesprevios', ['Alumno_id', 'Materia_id'])

        # Removing unique constraint on 'DocSolicitado', fields ['alumno', 'tipo_doc']
        db.delete_unique(u'principal_docsolicitado', ['alumno_id', 'tipo_doc'])

        # Deleting model 'DocSolicitado'
        db.delete_table(u'principal_docsolicitado')

        # Deleting model 'SaberesPrevios'
        db.delete_table(u'principal_saberesprevios')

        # Deleting model 'kardex'
        db.delete_table(u'principal_kardex')

        # Deleting model 'EvaluacionProfesor'
        db.delete_table(u'principal_evaluacionprofesor')
    ...
    models = {
        ...
        u'principal.kardex': {
            ...
            'alumno': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Alumno']"}),
            'alumno_grupo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.AlumnoTomaClaseEnGrupo']"}),
            'calificacion': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'evaluacion': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'materia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Materia']"}),
            'total_creditos': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
