...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Horario.lunes'
        db.delete_column(u'principal_horario', 'lunes')

        # Deleting field 'Horario.jueves'
        db.delete_column(u'principal_horario', 'jueves')

        # Deleting field 'Horario.miercoles'
        db.delete_column(u'principal_horario', 'miercoles')

        # Deleting field 'Horario.martes'
        db.delete_column(u'principal_horario', 'martes')

        # Deleting field 'Horario.viernes'
        db.delete_column(u'principal_horario', 'viernes')


    def backwards(self, orm):
        # Adding field 'Horario.lunes'
        db.add_column(u'principal_horario', 'lunes',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horario.jueves'
        db.add_column(u'principal_horario', 'jueves',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horario.miercoles'
        db.add_column(u'principal_horario', 'miercoles',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horario.martes'
        db.add_column(u'principal_horario', 'martes',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horario.viernes'
        db.add_column(u'principal_horario', 'viernes',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)
