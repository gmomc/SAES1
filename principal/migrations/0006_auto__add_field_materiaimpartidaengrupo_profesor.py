...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MateriaImpartidaEnGrupo.profesor'
        db.add_column(u'principal_materiaimpartidaengrupo', 'profesor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['principal.Profesor']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'MateriaImpartidaEnGrupo.profesor'
        db.delete_column(u'principal_materiaimpartidaengrupo', 'profesor_id')
